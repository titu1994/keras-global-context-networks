...
def GCDenseNet(input_shape=None,
               depth=40,
               nb_dense_block=3,
               growth_rate=12,
               nb_filter=-1,
               ...
               classes=10,
               activation='softmax'):
    '''Instantiate the GC DenseNet architecture
        # Arguments
...
def GCDenseNetImageNet121(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
                          ...
                          classes=1000,
                          activation='softmax'):
    return GCDenseNet(input_shape, depth=121, nb_dense_block=4, growth_rate=32, nb_filter=64,
...
def GCDenseNetImageNet169(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
                          ...
                          classes=1000,
                          activation='softmax'):
    return GCDenseNet(input_shape, depth=169, nb_dense_block=4, growth_rate=32, nb_filter=64,
...
def GCDenseNetImageNet201(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
                          ...
                          classes=1000,
                          activation='softmax'):
    return GCDenseNet(input_shape, depth=201, nb_dense_block=4, growth_rate=32, nb_filter=64,
...
def GCDenseNetImageNet264(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
...
def GCDenseNetImageNet161(input_shape=None,
                          bottleneck=True,
                          reduction=0.5,
                          dropout_rate=0.0,
                          weight_decay=1e-4,
                          ...
                          classes=1000,
                          activation='softmax'):
    return GCDenseNet(input_shape, depth=161, nb_dense_block=4, growth_rate=48, nb_filter=96,
